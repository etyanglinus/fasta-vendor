...
class AppConstants {
  ...
  static const String vendorCustomDomainUri = '/api/v1/vendor/custom-domain';
  static const String vendorShopAnalyticsUri = '/api/v1/vendor/store-visits';
  static const String vendorVehicleDispatchUri = '/api/v1/vendor/vehicle-dispatch';
