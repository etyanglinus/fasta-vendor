...
import 'package:fasta_deliveries_vendor/features/rental_module/chat/screens/taxi_chat_screen.dart';
import 'package:fasta_deliveries_vendor/features/rental_module/trips/controllers/trip_controller.dart';
import 'package:fasta_deliveries_vendor/features/rental_module/trips/screens/trip_details_screen.dart';
import 'package:fasta_deliveries_vendor/helper/custom_print_helper.dart';
...
import 'package:fasta_deliveries_vendor/features/dashboard/widgets/new_request_dialog_widget.dart';
...
class NotificationHelper {
  ...
  static Future<void> showTextNotification(String title, String body, NotificationBodyModel notificationBody, FlutterLocalNotificationsPlugin fln) async {
    const AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      'fasta_deliveries_vendor', AppConstants.appName, playSound: true,
  ...
  static Future<void> showBigTextNotification(String? title, String body, NotificationBodyModel notificationBody, FlutterLocalNotificationsPlugin fln) async {
    ...
    AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      'fasta_deliveries_vendor', AppConstants.appName, importance: Importance.max,
  ...
  static Future<void> showBigPictureNotificationHiddenLargeIcon(String? title, String? body, NotificationBodyModel notificationBody, String image, FlutterLocalNotificationsPlugin fln) async {
    ...
    final AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      'fasta_deliveries_vendor', AppConstants.appName,
...
Future<void> _initService() async {
  FlutterForegroundTask.init(
    androidNotificationOptions: AndroidNotificationOptions(
      channelId: 'fasta_deliveries_vendor',
